...
*/
// If i write thid addFn(a,b) function in different file then how can I access this file (answer is require keyWord)
...
// { addFn: [Function: addFn], subFn: [Function: subFn] }
 ...
 console.log("Sub = ",math.subFn(50,45)); // after exporting addFn from math.js 